...
{% include image.html class="right" title="Integrated Defense Acquisition, Technology, and Logistics Life Cycle Management System &ndash; What a Mouthful" file="atl_wall_chart.jpg" %}
...
{% include image.html class="left" title="Indications and Warnings of Civil Conflict in Iraq" file="iraq-iw.jpg" %}
...
{% include image.html class="" title="Edward Tufte's Analysis of a Columbia Risk Assessment Slide from [PowerPoint Does Rocket Science](http://www.edwardtufte.com/bboard/q-and-a-fetch-msg?msg_id=0001yB)" file="columbia-pp.gif" %}
